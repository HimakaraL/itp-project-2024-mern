...
export const SideBar = () => {
  ...
  const Menus = [
    { title: 'Dashboard', icon: <HiChartPie/>, href: '/admin/maintain/dashboard' },
    { title: 'Home', icon: <TiHome/>, href: '/admin/dashboard' },
    { title: 'New Schedule', icon: <CgFileDocument/>, href: '/admin/maintain/dashboard/create' },
    { title: 'All Schedules', icon: <GiConfirmed/>, href: '/admin/maintain/dashboard/view' },
