...
const ApprovedPage = () => {
  ...
  const showSuccess = () => {
    toast.success('Reservation is approved successfully!',{
  ...
  return (
    <div className="h-[100vh] px-4 pt-4">
      <div className="flex justify-between p-6 mb-6 rounded-xl bg-sidebar-blue">
        <h2 className="text-3xl font-bold text-white ">Approve Reservation</h2>
      </div>
      <form
      ...
      >
        ...
        <div className="flex justify-between">
          ...
          <Button
            onClick={handleApprovedReservation}
            type=""
            className="w-full h-10 bg-green-600 shadow-lg rounded-2xl"
          >
            Approve
          </Button>
        </div>
