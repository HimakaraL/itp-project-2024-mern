...
const ManageReservations = () => {
  ...
  const handleSearch = () => {
    setLoading(true);
    fetch(`http://localhost:3000/reservation/search-pending?query=${query}`, {
      method: "GET",
      headers: {
        "Content-Type": "application/json",
        Authorization: `Bearer ${user.token}`,
  ...
  const handleExport = async () => {
    ...
    const columnWidths = [40, 45, 45, 30, 130, 30, 50, 29, 29];
      ...
      reader.onloadend = () => {
        ...
        const docDefinition = {
          content: [
            ...
            { text: "Pending Reservations Report", style: "header" },
            {
              table: {
                headerRows: 1,
                widths: columnWidths,
        ...
        pdfDoc.download("pending_reservations.pdf");
      };
    } catch (error) {
  ...
  return (
    <div className="h-[120vh] px-4 pb-4">
          ...
          {currentPosts?.map((reservation, index) => (
            ...
            >
              <Table.Row className="dark:border-gray-700">
                ...
                <Table.Cell>
                  <button className="px-4 py-1 mr-2 font-semibold text-white bg-blue-600 rounded-xl hover:bg-blue-800">
                    <Link
                  ...
                  <button className="px-4 py-1 mr-2 font-semibold text-white bg-red-600 rounded-xl hover:bg-red-800">
                    <Link
                  ...
                  <button className="px-4 py-1 font-semibold text-white bg-green-600 rounded-xl hover:bg-green-800">
                    <Link
